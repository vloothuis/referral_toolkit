defmodule ReferralToolkit.Migrations do
  @moduledoc false
  ...
  def migrated_version(opts) do
    ...
    WHERE pg_class.relname = 'referral_toolkit_referrals'
  ...
  defp record_version(%{prefix: prefix}, version) do
    execute("COMMENT ON TABLE #{inspect(prefix)}.referral_toolkit_referrals IS '#{version}'")
  end
